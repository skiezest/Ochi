...
class GlaucomaRenderer: FilterRenderer {
    ...
    init() {
        ...
        let kernelFunction = defaultLibrary.makeFunction(name: "glaucoma")
        do {
    ...
    func render(pixelBuffer: CVPixelBuffer) -> CVPixelBuffer? {
        ...
        let maskTexture = try! textureLoader.newTexture(cgImage: (UIImage(named: "GlaucomaMask")?.cgImage)!, 
                                                        options: [:])
