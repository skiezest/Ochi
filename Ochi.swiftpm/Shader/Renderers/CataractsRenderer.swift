...
class CataractsRenderer: FilterRenderer {
    ...
    init() {
        ...
        let kernelFunction = defaultLibrary.makeFunction(name: "cataracts")
        do {
    ...
    func render(pixelBuffer: CVPixelBuffer) -> CVPixelBuffer? {
        ...
        let maskTexture = try! textureLoader.newTexture(cgImage: (UIImage(named: "CataractsMask")?.cgImage)!,
                                                        options: [:])
