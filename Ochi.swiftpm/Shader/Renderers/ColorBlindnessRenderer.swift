...
class ColorBlindnessRenderer: FilterRenderer {
    ...
    var severityLevelCoefficient: CGFloat {
    ...
    func render(pixelBuffer: CVPixelBuffer) -> CVPixelBuffer? {
        ...
        var floatValue: Float = Float(severityLevelCoefficient)
        commandEncoder.setBytes(&floatValue, length: MemoryLayout<Float>.size, index: 0)
