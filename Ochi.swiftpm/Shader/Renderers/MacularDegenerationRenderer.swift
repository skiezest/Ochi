...
class MacularDegenerationRenderer: FilterRenderer {
    ...
    init() {
        ...
        let kernelFunction = defaultLibrary.makeFunction(name: "macularDegeneration")
        do {
    ...
    func render(pixelBuffer: CVPixelBuffer) -> CVPixelBuffer? {
        ...
        let maskTexture = try! textureLoader.newTexture(cgImage: (UIImage(named: "MacularDegenerationMask")?.cgImage)!, 
                                                        options: [:])
